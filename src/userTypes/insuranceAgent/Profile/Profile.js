...
export default function Profile() {
  const [form, setForm] = useState({
    fullName: "Sara Insurance",
    licenseNo: "LIC-12345",
    phone: "+92 300 1111111",
    city: "Karachi",
    company: "Joy Insurance Partners",
    bio: "I provide fast and transparent insurance quotes for car owners.",
  });
      ...
      <div className="panel">
        <div className="panelHeader">
          <div>
            ...
            <p className="panelSub">Create / update your insurance agent profile (UI only)</p>
          </div>
        </div>
          ...
          <form onSubmit={onSave} className={styles.form}>
            <div className="grid2">
              ...
              <div className={styles.field}>
                ...
                <input className="input" value={form.licenseNo} onChange={onChange("licenseNo")} />
              </div>
              <div className={styles.field}>
              ...
              <div className={styles.field}>
                ...
                <input className="input" value={form.company} onChange={onChange("company")} />
              </div>
            </div>
